...
今日は六本木の方で作業していた。生産性はあまり高くなかったかもしれない。

## 2026-09-25

今日は午前中golf rangeに行き、そのあと渋谷に向かった。
筋力の左右差、特に左手首周りは重点的に鍛えないとな、と日に日に感じる.

渋谷は相変わらずの人集りで賑わっていた。やっぱり渋谷は歩いているだけで楽しいエリア.

## 2026-09-24

> How about if we each pick just one genre to talk about?

こんな感じの一文をbritish accentで聞いたとき "genre" が全然聞き取れなかった.
ZHON-rə みたいに聞こえる上に、genre と toの間に小さい「ッ」が入っているように聞こえて、「ジョンレット」to talk about　にしか聞こえず困惑した.
無声区間に対して脳が「っ」であると補完してしまっているのだろうけれど、そもそも良く良く考えたら、音のない無声区間に対して「っ」という文字を当てはめている日本語も結構不思議あなとか思った.

## 2026-09-23

今日は代官山周辺で作業をしていた。

たまたま「否が応でも」と打つ機会があり、予測変換に自信がなかったので調べていたところ、[いやが応でも？いやが上にも？](https://www.nhk.or.jp/bunken/summary/kotoba/term/076.html)という記事が出てきた。
あまり聞いたことがなかったのだが、催し物など、盛り上がっているものが、ますます盛んに甚だしくなる様子を表す際に使うらしい。
またひとつ勉強になった。

## 2026-09-22

今日は丸の内周辺で作業していた。
台風一過で、昼頃は久々に30度近くあったよう.

ところで、最近はghosttyではなく、macのdefault terminalに回帰している。
default terminalの"pro" profileはやはり独特の良さがあって気に入っている。

## 2026-09-21

今日は六本木で作業していた。
夜遅くには雨が止んでいて、けやき坂ではクリスマスにむけたイルミネーションの設置が、早くも執り行われていた。

## 2026-09-20

今日は東京駅周辺での作業。
夜帰る頃には台風の影響か、凄まじい土砂降りの雨になっていた。
雨の丸の内も雰囲気がすごく良くて気に入っている。

## 2026-09-19

気づいたら1日が終わっていた。
今日はずっとbritish englishに浸かっていた。
...
どうやら、qspace, bloom, forkliftなどが有名どころらしい。
webページをざっくりと見たがあまりしっくりこなかった。
何でもdefaultに慣れる、極める方が好きなので、逆にfinderで便利なshortcutを極める方向性でgptに聞いたところ、
cmd + 2, cmd + 3, cmd + shift + g あたりを紹介されたが、これが非常に便利。
特に、cmd + 2 <-> cmd + 3で簡単にリストと階層構造のビューを切り替えられるのが良い。
cmd + shif + gで直接 pathを入力できるのも良い。
opt + cmd + space, opt + cmd + lなどは普段からよく使っていたが、これらに合わせて徐々にfinderのadvandedなshortcutを習得していきたい.

macOS 27, golden gateで、ghosttyのtab表示にバグがある問題が前々から気になっていたが、どうやらdev verだと修正されているとの情報を聞き、試しに入れてみたところ正常に表示されるようになった。
2ヶ月近く微妙に不満に思っていたことが解消されて非常に気分が良い。

最近忙しくてあまり見ていなかった、友人のgit logを久々に眺めていた。
以前、おすすめしていた三体をどうやら読み始めてくれた人がいるらしい。
今までに10人以上におすすめしてきたが、3部作、全巻読み終えたのは今の所、2つ上の元研究室の先輩ただ一人だけなので, 同様に最後まで完走してくれることを祈っている。
そんなにSF小説を読んでいるわけではないので、あんまり批評できる立場にないけれど、三体は本当に面白かった。

みんな、色々と必死に頑張っていることが伝わってきて非常に良い.
自分も頑張らないと.
...
あまりにもtokenが足りず、遂にclaude max 20x planを契約してしまった。
今までGPT Pro 5xとclaude max 5xで十分足りていたが、最近の新規プロジェクトはcoding量が多く、足りなくなってしまった。
claude max 20xは5hごとのlimitも非常に余裕があって、今のところかなり快適に使えている。

今日は今の所, 人生で一番commit & pushした日となった.

## 2026-09-14

今日は研究関連のことをメインに作業していた.
計算資源も、tokenもいくら合っても足りない.

teslaがroadstarをいよいよ発売するそう。2018にプレスリリースを見た時から楽しみにしていて、しばらく音沙汰がなかったので心配していたが、無事お披露目になるらしい.

## 2026-09-13

今日は時差ぼけを直しつつ研究なりcoding形をしていた.
午後、高校時代の友人と難波であった. ロケットのlanding時における姿勢制御に関する研究をしているそう.
非常に話があった.
...
今日はRomeを出発して帰路へ.
ただ今の時点でRome-> Helsikiが2hours以上遅れており、Helsinkiでの国際線乗り換えに間に合うかどうかは不明,,

## 2026-09-09

今日はRomeを観光した.
本当に街全体が遺跡そのもので、紀元前の産物が今もこうして残っていることが非常に不思議に感じられた.
また、世界最小の国であるVatican Cityにも行ってきた.
Saint Peter’s Basilicaは世界最大のChristianの教会ということで、その荘厳な出で立ち圧倒された.

## 2026-09-08

今日はFlorenceを観光していた。
教会であるPiazza del Duomoは写真で見るよりも遥かに迫力があった.

午後は南下してPienzaを訪れた.
Renaissanceにおける理想の都市として設計された小さな町.
広大な田園風景の中にひっそりと佇む理想郷のような雰囲気を醸し出している.

## 2026-09-07

今日は Cinque Terre を訪れた.
カラフルな建物と、傾斜にある段々畑、そして一面に広がる海の対比が非常に美しかった.

## 2026-09-06

今日はVeniceの方にやってきた.
迷路のように張り巡らされている水路をgondolaに乗って進んでいき、その美しい街並みを鑑賞した.
夕方にはFlorenceの方に向い、明日の観光に備える.

## 2026-09-05

Helsinki経由でMilanにやって来た.
以前、logで話題に上げたVittorio Emanuele 2nd の像を前に何だか伏線を回収したような気分になった.
MilanはItalyの中でも比較的緯度が高い方ではあるが、今日は日中の気温が31°Cで、直射日光の下ではかなり暑い印象を受けた.
夕方には、Veniceの方のホテルまでバスで移動.
一刻も早く時差ボケを治したい.
...
今日は関西国際空港に来ている。
これから人生初Finnairに搭乗.
Finnairは、Helsinkiをハブとして、アジアとヨーロッパを繋ぐ路線に強みを持っているようだ。
